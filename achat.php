...
$images = [
    [ '201209-pastilles+livret-w.jpg', 'horizontal', "Pastilles béton, diamètre 42 cm, 18 kg, signée au dos, 2009, 200 €. Livret surface vivante, 15 €", ''],
...
?>
            ...
            <div id ="presentationRealisation">
                <h2>achat</h2>
                <p>Pour toute commande (livret, dessin, peinture...) merci de m'adresser un mail. Le paiement peut s'effectuer par virement, paylib.</p>
            </div>
